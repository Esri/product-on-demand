...
define({
    ...
    podConfig: {
        ...
        AppLevelSettings: {
            ...
            // Header
            logoImage: "images/esri-logo.png", // image size is recalculated automatically according to CSS settings
            ...
            splashText: "This is a sample implementation of the Esri Production Mapping for Server extension.",
            splashEmailDesc: "Email For More Information",
            splashEmail: "productionmapping@esri.com",
            ...
            // If Gateway address changes, update the <serverUrl> tag content in ..\proxy\proxy.config
        ...
        ExtentLayers: [
            ...
            { value: "Boundaries", url: "http://<yourServer>/arcgis/rest/services/mcs_pod/ExtentLayers/MapServer", sublayer: 1, data0: "STATE_NAME" }
        ],
        ...
        PageSizeList: [
            ...
            { value: "24.9 34.7 CENTIMETERS", displayName: "FixedProduct", tooltip:"FixedProduct 24.9*34.7 cm"},
        ...
        // Individual product attribute tables inherit, and may override data from the BaseProductTable.
        // Product instance tables inherit attributes from both product attribute tables and the BaseProductTable.
        // Do not alter the attributes in the BaseProductTable or the BaseInstanceTable.
        // Instead override them by defining them in the product tables themselves with the structure below.

        // attr - specifies the product attribute name
        // displayName - shows the attribute in UI and is visible when a non-empty string is set as value. Is hidden when empty string is set as value
        // value - initial attribute value
        // domain - specifies the application domains to derive possible attribute values from
        // filter - allows creation of a subset of domain values
        // isEditable - determines if the attribute is editable in a textbox or combo box by the web user
        // passToServer - determines whether or not to pass the attribute to export as part of the product definition
        // source - attribute value would be taken from the corresponding extent layer data field definition

        // Required Definition for Products
        BaseProductTable: [ // this table defines the base product properties for all products
        ...
        // Required Definition for Instances
        BaseProductInstanceTable: [ // this table defines product properties for all product instances in the export queue
        ...
        // ############################################
        // Create settings to define new products or override base product settings
        
    
        // Settings for POD Samples
        // Setting Fixed 25K Sample start .. 
        Fixed25KTable: [
            ...
            { attr: "scale", domain: "ScaleList", value: 25000, passToServer: false, isEditable: false },        
        ...
        // .. end of Fixed 25K Sample
        
        // Dynamic Area Sample start .. 
        DynamicAreaTable: [
        ...
        // Append new ProductDefinitions
        ProductDefinitions: [
            // Add product tables and instance tables in this list to display them in POD web application
            
            
            // To set up the samples as described in the Deployment Guide.pdf
            // Remove "//" to uncomment the lines below, to enable the sample products in your POD application
