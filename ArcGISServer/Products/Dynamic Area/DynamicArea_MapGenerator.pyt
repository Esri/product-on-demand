...
creating a new map for the Dynamic Area product"""
import arcpy
...
class Toolbox(object):
    ...
    def __init__(self):
        ...
        self.label = "DynamicArea Tools"
        self.alias = "dynamicAreaTools"
...
class MapGenerator(object):
    ...
    def __init__(self):
        ...
        self.description = "Python Script used to create a new map for the Dynamic Area product"
    ...
    def execute(self, parameters, messages):
        ...
        try:
            ...
            #end of workaround
            # Set the dataframe position based on any page margin
            ...
            # Add border to the main dataframe
