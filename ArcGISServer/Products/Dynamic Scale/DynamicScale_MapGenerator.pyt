...
creating a new map for the Dynamic Scale product"""
import arcpy
...
class Toolbox(object):
    ...
    def __init__(self):
        ...
        self.label = "DynamicScale Tools"
        self.alias = "dynamicScaleTools"
...
class MapGenerator(object):
    ...
    def __init__(self):
        ...
        self.description = "Python Script used to create a new map for the Dynamic Scale product"
